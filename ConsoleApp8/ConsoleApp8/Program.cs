...
{
    var Receptions = db.Receptions.ToArray();
    Console.WriteLine("Список объектов");
    foreach (Reception u in Receptions)
    {

        Console.WriteLine(u.ReceptionID + " " + u.DataRec + " " + u.DataFinal + " "
            + u.DiagnosisID + " " + u.DocID + " " + u.PacID + " " + u.NumRecipe + " " + u.NumAnalysis);
    }
}
/* using (ApplicationContext db = new ApplicationContext())
{
